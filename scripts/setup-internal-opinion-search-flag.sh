...
aws dynamodb put-item --region us-east-1 --table-name "efcms-deploy-${ENV}" --item '{"pk":{"S":"internal-opinion-search-enabled "},"sk":{"S":"internal-opinion-search-enabled "},"current":{"BOOL":true}}'
