...
describe('Unauthed user views todays orders', () => {
  ...
  integrationTest.documentTitle1 = uniqueDocumentTitle;
  ...
  integrationTest.documentTitle2 = uniqueDocumentTitle2;
  docketClerkCreatesAnOrder(testClient, {
  ...
  unauthedUserViewsTodaysOrders(integrationTest, testClient);

  loginAs(testClient, 'docketclerk@example.com');
  docketClerkSealsCase(testClient);

  unauthedUserViewsTodaysOrdersOnSealedCase(integrationTest);
});
