...
- Currently, the version of @sparticuz/chromium is one version behind the recommended version mentioned in the link above. However, this is a temporary but stable state.
