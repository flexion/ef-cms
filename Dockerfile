...
RUN wget -q -O terraform_1.0.1_linux_amd64.zip https://releases.hashicorp.com/terraform/1.0.1/terraform_1.0.1_linux_amd64.zip && \
  unzip -o terraform_1.0.1_linux_amd64.zip terraform && \
