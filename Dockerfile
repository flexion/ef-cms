...
FROM cypress/browsers:node-20.15.1-chrome-126.0.6478.126-1-ff-128.0-edge-126.0.2592.102-1
...
RUN curl "https://awscli.amazonaws.com/awscli-exe-linux-x86_64-2.17.20.zip" -o "awscliv2.zip" && \
  unzip awscliv2.zip && \
  ./aws/install && \
  rm -rf awscliv2.zip
