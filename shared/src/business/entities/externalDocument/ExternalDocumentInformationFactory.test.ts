...
describe('ExternalDocumentInformationFactory', () => {
  ...
  it('should require a primary document file', () => {
    ...
    expect(
      externalDocument.getFormattedValidationErrors().primaryDocumentFile,
    ).toEqual(VALIDATION_ERROR_MESSAGES.primaryDocumentFile[0].message);
  });

  it('should require whether certificate of service was provided or not', () => {
    const externalDocument = ExternalDocumentInformationFactory({
      category: 'Application',
      documentTitle: 'Application for Waiver of Filing Fee',
      documentType: 'Application for Waiver of Filing Fee',
    ...
    expect(
      externalDocument.getFormattedValidationErrors().certificateOfService,
  ...
  describe('attachments', () => {
    it('should set a default value for attachments when a value has not been provided', () => {
      ...
      expect(externalDocument.attachments).toBe(false);
    });
  });

  describe('certificateOfServiceDate', () => {
    it('should require certificate of service date be entered when a certificate of service was provided', () => {
      const externalDocument = ExternalDocumentInformationFactory({
        attachments: undefined,
        category: 'Application',
      ...
      expect(
        externalDocument.getFormattedValidationErrors()
          .certificateOfServiceDate,
      ).toEqual(VALIDATION_ERROR_MESSAGES.certificateOfServiceDate[1]);
    });

    it('should be invalid when provided certificate of service date is in the future', () => {
      const externalDocument = ExternalDocumentInformationFactory({
        attachments: undefined,
        category: 'Application',
        certificateOfService: true,
        certificateOfServiceDate: calculateISODate({
          howMuch: 1,
          units: 'days',
        }),
        documentTitle: 'Application for Waiver of Filing Fee',
      ...
      expect(
        externalDocument.getFormattedValidationErrors()
          .certificateOfServiceDate,
      ).toEqual(VALIDATION_ERROR_MESSAGES.certificateOfServiceDate[0].message);
    });
  });
  ...
  describe('Motion Document', () => {
    ...
    it('should require a value for objections', () => {
      const externalDocument = ExternalDocumentInformationFactory({
        attachments: undefined,
        category: 'Motion',
        certificateOfService: true,
      ...
      expect(
        externalDocument.getFormattedValidationErrors().objections,
    ...
    it('should require objections for an Amended document with a Motion previousDocument', () => {
      ...
      expect(errors().objections).toEqual(VALIDATION_ERROR_MESSAGES.objections);
  ...
  describe('Has Supporting Documents', () => {
    ...
    it('should require certificate of service date to be entered if certificateOfService is true', () => {
      ...
      baseDoc.supportingDocuments[0].supportingDocument = 'brief';
      expect(errors().supportingDocuments[0].certificateOfServiceDate).toEqual(
    ...
    describe('Brief Supporting Document', () => {
      ...
      it('should require supporting document file to be selected', () => {
        expect(errors().supportingDocuments[0].supportingDocumentFile).toEqual(
          VALIDATION_ERROR_MESSAGES.supportingDocumentFile[0].message,
        );

        baseDoc.supportingDocuments[0].supportingDocumentFile = { size: 1 };
    ...
    describe('Affidavit Supporting Document', () => {
      ...
      it('should require supporting document text to be added', () => {
        ...
        baseDoc.supportingDocuments[0].supportingDocumentFreeText = 'Something';
        expect(
          errors().supportingDocuments[0].supportingDocumentFreeText,
        ).toEqual(undefined);
      });
  ...
  describe("Scenario 'Nonstandard H' Secondary Document", () => {
    ...
    describe('Motion for Leave to File Out of Time', () => {
      ...
      it('should require secondary document file be added', () => {
        ...
        baseDoc.secondaryDocumentFile = { size: 1 };
      ...
      describe('Has Supporting Secondary Documents', () => {
        ...
        it('should require supporting secondary document type be entered', () => {
          ...
          baseDoc.secondarySupportingDocuments[0].supportingDocument = 'brief';
