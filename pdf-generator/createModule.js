...
const { css } = sass.compile('src/htmlGenerator/index-main.scss');
fs.writeFileSync('src/htmlGenerator/index.scss', css);

// USAGE EXAMPLE: node createModule.js path1/file1 path2/file2
const targets = ['src/htmlGenerator/index.pug', 'src/htmlGenerator/index.scss'];
