resource "aws_iam_role" "iam_cognito_user_migration_lambda_role" {
  name = "iam_cognito_user_migration_lambda_role_${var.environment}"
...
resource "aws_iam_role_policy" "iam_cognito_user_migration_lambda_policy" {
  name = "iam_cognito_user_migration_lambda_policy_${var.environment}"
  role = aws_iam_role.iam_cognito_user_migration_lambda_role.id
