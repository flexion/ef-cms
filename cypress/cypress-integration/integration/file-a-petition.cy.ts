...
describe('File a petition', { scrollBehavior: 'center' }, () => {
...
describe('before filing a petition', { scrollBehavior: 'center' }, () => {
  beforeEach(() => {
...
describe('creation form', { scrollBehavior: 'center' }, () => {
  before(() => {
...
describe('can view case detail', { scrollBehavior: 'center' }, () => {
  before(() => {
