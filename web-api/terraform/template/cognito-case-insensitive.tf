resource "aws_cognito_user_pool" "pool_case_insensitive" {
...
resource "aws_cognito_user_pool_client" "client_case_insensitive" {
  name = "client_case_insensitive"
  ...
  user_pool_id = aws_cognito_user_pool.pool_case_insensitive.id
